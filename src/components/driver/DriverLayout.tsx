...
export function DriverLayout({ children, title }: DriverLayoutProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-zinc-950 pb-[calc(4rem+env(safe-area-inset-bottom,0px))]">
      {/* Top Header */}
      ...
      {/* Bottom Navigation */}
      <nav 
        className="fixed bottom-0 z-50 w-full border-t border-border bg-background pt-1 pb-[env(safe-area-inset-bottom,0px)]"
      >
